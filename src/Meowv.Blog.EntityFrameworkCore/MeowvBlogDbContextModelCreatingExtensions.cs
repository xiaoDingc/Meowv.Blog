...
namespace Meowv.Blog
{
    ...
    {
        public static void Configure(this ModelBuilder moduleBuilder)
        {
            //Check.NotNull(moduleBuilder, nameof(moduleBuilder));
            Check.NotNull(moduleBuilder, nameof(moduleBuilder));

            moduleBuilder.Entity<Post>(b=>
            {
            ...
            moduleBuilder.Entity<Category>(b =>
            {
            ...
            moduleBuilder.Entity<PostTag>(b =>
            {
            ...
            moduleBuilder.Entity<FriendLink>(b =>
            {
